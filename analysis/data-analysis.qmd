...
ggsave(here("results", "CA-NO2.png"), plot = p, width = 5, height = 5, units = "in", dpi = 400)
p
...
ggsave(here("results", "CA-ZEV.png"), plot = p, width = 5, height = 5, units = "in", dpi = 400)
p
```
...
p
ggsave(here("results", "data-MTP-comparison.png"), p, width = 8, height = 4, dpi = 400)
...
ggsave(here("results", "data-MTP-grid2.png"), width = 6, height = 3, dpi = 400)
```
